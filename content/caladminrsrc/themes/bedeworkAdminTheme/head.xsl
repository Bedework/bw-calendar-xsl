...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <xsl:template name="head">
      <head>
        ...
        <!-- load jQuery -->
        <script type="text/javascript" src="/approots/bedework-common/javascript/jquery/jquery-1.11.3.min.js">/* jQuery */</script>
        <script type="text/javascript" src="/approots/bedework-common/javascript/jquery/jquery-ui-1.11.4.min.js">/* jQuery UI */</script>
        <link rel="stylesheet" href="/approots/bedework-common/javascript/jquery/css/jquery-ui-1.11.0/jquery-ui.min.css"/>
        <link rel="stylesheet" href="/approots/bedework-common/javascript/jquery/css/jquery-ui-1.11.0/jquery-ui.theme.min.css"/>
        ...
        <xsl:if test="/bedework/page='modEvent' or
          ...
          <!-- load libraries -->
          <script type="text/javascript" src="/approots/bedework-common/javascript/jquery/autocomplete/select2.min.js">/* Autocomplete combobox */</script>
          <link rel="stylesheet" href="/approots/bedework-common/javascript/jquery/autocomplete/select2.min.css"/>
          <script type="text/javascript" src="/approots/bedework-common/javascript/jquery/magnific/jquery.magnific-popup.min.js">/* for export/subscribe lightbox */</script>
          <link rel="stylesheet" type="text/css" media="screen" href="/approots/bedework-common/javascript/jquery/magnific/magnific-popup.css" />
          ...
          <script type="text/javascript" src="/approots/bedework-common/javascript/bedework/bedeworkXProperties.js">/* Bedework X-Property Handling */</script>
          <script type="text/javascript" src="/approots/bedework-common/javascript/bedework/bwClock.js">/* Bedework clock widget */</script>
        ...
        <xsl:if test="/bedework/page='modCalendar' or
          ...
          <script type="text/javascript" src="/approots/bedework-common/javascript/bedework/bedeworkAccess.js">/* Bedework Access Control handling */</script>
        ...
        <xsl:if test="/bedework/page='calSuitePrefs'">
          <script type="text/javascript" src="/approots/bedework-common/javascript/jquery/jquery-1.3.2.min.js">/* jQuery */</script>
          <script type="text/javascript" src="{$resourcesRoot}/javascript/bedework.js">/* Bedework */</script>
