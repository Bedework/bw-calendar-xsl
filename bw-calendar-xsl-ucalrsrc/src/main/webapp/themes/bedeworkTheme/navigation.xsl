    ...
    <div id="bwTabs">
      ...
      <ul>
        ...
        <li>
          ...
          <a href="{$listEvents}&amp;listMode=true&amp;fexpr=(colPath=%22{$usersRootCal}%22 and (entity_type=%22event%22 or entity_type=%22todo%22))&amp;sort=dtstart.utc:asc"><xsl:copy-of select="$bwStr-Tabs-Upcoming"/></a>
        </li>
