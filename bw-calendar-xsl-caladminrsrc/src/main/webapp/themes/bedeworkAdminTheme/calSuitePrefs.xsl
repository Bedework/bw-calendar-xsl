      ...
      <table class="common2">
        ...
        <xsl:if test="$isSuperUser">
          ...
          <tr>
            ...
            <td>
              <input type="text" name="approvers" id="csApprovers" value="" size="50">
                <xsl:attribute name="value"><xsl:value-of select="/bedework/prefs/calsuiteApprovers"/></xsl:attribute>
              </input>
            </td>
          </tr>
          <tr>
