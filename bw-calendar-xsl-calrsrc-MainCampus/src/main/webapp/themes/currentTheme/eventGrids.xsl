...
<xsl:stylesheet
  ...
  <!--==== WEEK CALENDAR VIEW ====-->
  <xsl:template name="weekGrid">
    <table id="gridCalendarTable" border="0" cellpadding="0" cellspacing="0">
      <tr>
  ...
  <xsl:template match="event" mode="calendarLayout">
    ...
    <li>
      <a href="{$eventView}&amp;href={$href}" class="{$eventClass} {$subscriptionClass}">
